...
void ELFFile::load(std::string_view filename)
{
#ifdef _MSC_VER
...
bool ELFFile::isTarget(const uint8_t elf_class,
...
bool ELFFile::getTextSegment(std::vector<std::byte> &segmentData,
