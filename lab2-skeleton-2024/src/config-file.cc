...
void ConfigFile::load(std::string_view filename)
{
  clear();
...
bool ConfigFile::hasSection(std::string_view sectionName) const
{
...
bool ConfigFile::hasProperty(std::string_view sectionName,
...
void ConfigFile::addSection(std::string_view sectionName)
{
  sections.emplace_back(sectionName);
}

void ConfigFile::addProperty(const PropertyName &propertyName,
