...
RegNumber InstructionDecoder::getA() const
{
  if (getFormat() == R_FORMAT || getFormat() == I_FORMAT || getFormat() == S_FORMAT || getFormat() == B_FORMAT) {
    return static_cast<RegNumber>((instructionWord >> 15) & 0x1F);
  }
  return 0; 
}
...
RegNumber InstructionDecoder::getB() const
{
  if (getFormat() == R_FORMAT || getFormat() == S_FORMAT || getFormat() == B_FORMAT) {
    return static_cast<RegNumber>((instructionWord >> 20) & 0x1F);
  }
  return 0; 
}
...
RegNumber InstructionDecoder::getD() const
{
  if (getFormat() == R_FORMAT) {
    return static_cast<RegNumber>((instructionWord >> 7) & 0x1F);
  }
  return 0; 
}
